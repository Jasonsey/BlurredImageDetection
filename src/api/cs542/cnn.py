...
trainblur_directory = '../../../data/output/cs542/s_cnn/train/blur/'
trainnoblur_directory = '../../../data/output/cs542/s_cnn/train/no_blur/'
filepath = "../../../data/output/cs542/s_cnn/models/"
...
tensorboard_callback = callbacks.TensorBoard(log_dir='./logs', histogram_freq=0, batch_size=32, write_graph=True, write_grads=False, write_images=False, embeddings_freq=0, embeddings_layer_names=None, embeddings_metadata=None)
